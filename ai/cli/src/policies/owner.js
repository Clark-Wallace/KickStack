...
exports.OwnerPolicyGenerator = void 0;
class OwnerPolicyGenerator {
    /**
...
`;
     ...
     */
    static generateColumnCheckQuery(table, column) {
        return `
      SELECT EXISTS (
        SELECT 1 
...
exports.OwnerPolicyGenerator = OwnerPolicyGenerator;
